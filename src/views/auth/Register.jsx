                ...
                <div className='bg-[#283046] p-4 rounded-md'>
                    ...
                    <form onSubmit={submit}>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input onChange={inputHandel} value={state.name} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden'  type='text' name='name' placeholder='name' id='name' required/>
                        </div>
                        <div className='flex flex-col w-full gap-1 mb-3'>
